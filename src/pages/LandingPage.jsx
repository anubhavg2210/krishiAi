      ...
      <div className="w-full mt-24 pb-12 flex flex-col items-center justify-start gap-8 relative text-center z-10">
        ...
        <div className="relative w-full max-w-7xl mt-12 mb-20 flex justify-center perspective-1000 z-10">
          <div className="relative  group w-full flex justify-center">
            ...
            <img
              src="/mp-crop-map.png"
              alt="Madhya Pradesh 3D Crop Map" className="w-full max-w-[600px] h-auto relative z-10 transition-transform duration-700 hover:-translate-y-5 hover:scale-105 hover:drop-shadow-[0_20px_50px_rgba(76,175,80,0.6)] cursor-pointer "
